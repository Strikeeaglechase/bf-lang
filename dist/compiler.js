...
const ARR_PADDING = 3;
class Scope {
    constructor(global, parent, varIdx, arrIdx) {
        this.vars = [];
        this.arrs = [];
        this.global = global;
    ...
    getArr(arrName) {
        ...
        if (local)
            return local;
        if (this.global)
            return this.global.arrs.find(v => v.name == arrName);
...
class Compiler {
    constructor(prog) {
        this.globalScope = new Scope(null, null, VAR_SPACE_START + VAR_SPACE_LEN - 1, ARR_SEG_START);

import { Compiler, DISPLAY_COLOR, DISPLAY_TYPE, DISPLAY_X, DISPLAY_Y } from "./compiler.js";
import * as AST from "./parser/types/AST.js";

export interface BuiltinFunc extends AST.FunctionDef {
	call: (this: Compiler) => void;
}

export const builtinFunctions: BuiltinFunc[] = [{
